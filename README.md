...
![Status](https://img.shields.io/badge/status-bronze_complete-orange)
...
│   ├── 04_anomaly_model.py       # 🔜 ML pipeline
...
- [ ] **v1.1** — Silver layer with type casting and validation
...
Data Engineer | Big Data | MBA student in Big Data
